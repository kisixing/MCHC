export default {
  ...
  'menu.child-management.hearing-screening-add': '儿童听力筛查添加',
  'menu.child-management.hearing-screening-edit': '儿童听力筛查编辑',
  'menu.child-management.nutritive-disease': '营养性疾病儿童',
  'menu.child-management.nutritive-disease-add': '营养性疾病儿童添加',
  'menu.child-management.nutritive-disease-edit': '营养性疾病儿童编辑',
