export default {
  ...
  'menu.labour-delivery': '分娩管理',
  'menu.labour-delivery.admission': '入院登记',
  'menu.labour-delivery.labour-record': '分娩记录',
  'menu.labour-delivery.nursing-record': '护理记录',
  'menu.labour-delivery.predelivery': '待产记录',
  'menu.labour-delivery.caesarean-delivery': '剖宫产记录',
  'menu.labour-delivery.deliver-form': '分娩记录单',
  'menu.labour-delivery.neonate-record': '新生儿记录',
  'menu.labour-delivery.postpartum-visit': '产后访视',
