...
const config: Array<FormConfig> = [
  ...
  { name: 'useridtype', key: '.useridtype', label: "证件类型", input_type: "select", span: 7, rules: "required", input_props:{selectOptions: [{ value: 1, label: 1 }]} },
  ...
  { name: 'userpeople', key: '.userpeople', label: "民族", input_type: "select", span: 7, rules: "required", input_props:{selectOptions: [{ value: 1, label: 1 }]} },
  { name: 'useroccupation', key: '.useroccupation', label: "职业", input_type: "select", span: 7, rules: "required", input_props:{selectOptions: [{ value: 1, label: 1 }]} },
  { name: 'maritalHistory', key: '.maritalHistory', label: "婚姻状态", input_type: "select", span: 7, rules: "required", input_props:{selectOptions: [{ value: 1, label: 1 }]} },
