...
const config: Array<FormConfig> = [
    ...
    { name: 'xiacsftype', key: '.diagnosis.xiacsftype', label: "下次复诊", input_type: "input", span: 6, rules: "required", input_props:{} },
    ...
    { name: 'xiacsfdatearea', key: '.diagnosis.xiacsfdatearea', label: "", input_type: "input", span: 6, rules: "required", input_props:{} },
