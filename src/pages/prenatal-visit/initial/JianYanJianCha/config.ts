...
const config: Array<FormConfig> = [
  ...
  { name: 'husbandCkxuex', key: '.lis.husbandCkxuex', label: "男方血型", input_type: "input", span: 5, input_props:{} },
  { name: 'husbandRh', key: '.lis。husbandRh', label: "", input_type: "input", span: 5, input_props:{} },
  ...
  { name: 'ckxuex', key: '.lis', label: "女方血型", input_type: "input", span: 5, input_props:{} },
  { name: 'ckrh', key: '.lis', label: "", input_type: "input", span: 5, input_props:{} },
  ...
  { name: 'add_FIELD_TSH', key: '.lis', label: "TSH", input_type: "input", span: 7, input_props:{} },
  { name: 'add_FIELD_free_t3', key: '.lis', label: "游离T3", input_type: "input", span: 7, input_props:{} },

  { name: 'add_FIELD_free_t4', key: '.lis', label: "游离T4", input_type: "input", span: 7, input_props:{} },
  { name: 'add_FIELD_lis_hb', key: '.lis', label: "HB", input_type: "input", span: 7, input_props:{} },
  { name: 'add_FIELD_lis_mcv', key: '.lis', label: "MCV", input_type: "input", span: 7, input_props:{} },
  { name: 'add_FIELD_lis_plt', key: '.lis', label: "PLT", input_type: "input", span: 7, input_props:{} },
  ...
  { name: 'ckfzother', key: '.lis', label: "其他", input_type: "input", span: 24, input_props:{} },
